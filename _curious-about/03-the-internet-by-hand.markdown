...
background: '<div class="hero__bgcenter"><img style="max-width: 20em; height: auto" class="image" src="//localhost:3000/assets/curious-about/the-internet-by-hand/tomte-sequence.gif"></div>'
